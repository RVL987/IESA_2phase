...
pip installed to user site: This happens if you didn't activate the venv. Activate the venv before pip install or use the full path to venv . pack\Scripts\pip.exe install package.
